...
(
    'Básico',
    'Plano básico com consultas e descontos em medicamentos',
    'individual',
    5000.00,
    1,
    JSON_ARRAY('2 consultas mensais', '10% desconto em medicamentos', 'Suporte 24/7'),
    2,
    10.00
),
(
    'Familiar',
    'Plano familiar para até 5 pessoas',
    'familiar',
    15000.00,
    1,
    JSON_ARRAY('5 consultas mensais', '15% desconto em medicamentos', 'Exames básicos incluídos', 'Suporte 24/7'),
    5,
    15.00
),
(
    'Premium',
    'Plano premium com consultas ilimitadas',
    'premium',
    25000.00,
    1,
    JSON_ARRAY('Consultas ilimitadas', '20% desconto em medicamentos', 'Exames incluídos', 'Monitoramento de saúde', 'Suporte prioritário'),
    NULL,
    20.00
),
(
    'Empresarial',
    'Plano para empresas e colaboradores',
    'empresarial',
    8000.00,
    1,
    JSON_ARRAY('3 consultas mensais por colaborador', '12% desconto em medicamentos', 'Medicina do trabalho', 'Relatórios de saúde'),
    3,
    12.00
);
...
-- Farmácia de teste
INSERT INTO farmacias (id, nome, endereco, cidade, provincia, zona, telefone, email, licenca, is_online, is_ativa, aprovada) VALUES
...
-- Hospital de teste
INSERT INTO hospitais (id, nome, endereco, cidade, provincia, telefone, email, licenca, tipo, especialidades, aprovada) VALUES
...
INSERT INTO empresas_transporte (id, nome, endereco, cidade, provincia, telefone, email, cnpj, aprovada) VALUES
...
-- Paciente de teste
INSERT INTO usuarios (id, nome_completo, email, telefone, senha_hash, tipo_usuario, status_conta, is_ativo, cidade, provincia) VALUES
...
-- Médico de teste
INSERT INTO usuarios (id, nome_completo, email, telefone, senha_hash, tipo_usuario, status_conta, is_ativo, cidade, provincia, entidade_id, entidade_tipo) VALUES
...
-- ============================================
INSERT INTO profissionais_saude (usuario_id, especialidade, numero_ordem, anos_experiencia, biografia, atende_domicilio, atende_online, valor_consulta_online, valor_consulta_domicilio, disponivel, hospital_id) VALUES
...
-- VEÍCULO DE TESTE
-- ============================================
INSERT INTO veiculos (empresa_id, placa, modelo, tipo, capacidade_kg, is_ativo) VALUES
